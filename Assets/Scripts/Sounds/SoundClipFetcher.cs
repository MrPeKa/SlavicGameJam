...
{
    public static class SoundClipFetcher
    {
        public static AudioClip GetRoomIntroMusic(RoomSound soundComponentName)
        {
            return GetClip(GetClipPath(soundComponentName), GameplayServices.Constants.INTRO);
        }
 
        public static AudioClip DeadSound(Creatures character)
        {
            return GetClip(GetClipPath(character), GameplayServices.Constants.DEAD);
        }
 
        public static AudioClip HitSound(Creatures character)
        {
            return GetClip(GetClipPath(character), GameplayServices.Constants.HIT);
        }

        public static AudioClip GetHitSound(Creatures character)
        {
            return GetClip(GetClipPath(character), GameplayServices.Constants.GET_HIT);
        }

        public static AudioClip GetFootStepsSound(Creatures character)
        {
